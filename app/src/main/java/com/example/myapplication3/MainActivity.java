...
public class MainActivity extends Activity implements SurfaceHolder.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // bean生成
        MainUnitMainActivityBean mainActivityBean = new MainUnitMainActivityBean();
...
//        mediaController.hide();
        ...
        mainActivityBean.setWaitingView(findViewById(R.id.main_unit_waiting));
        mainActivityBean.setAnnounceClerkView(findViewById(R.id.main_unit_announce_clerk));
